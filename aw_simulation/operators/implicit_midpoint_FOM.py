...
def implicit_midpoint_solver_FOM(y_0, right_hand_side, param, r_tol=1e-8, a_tol=1e-15, max_iter=100, verbose=True):
    """Solve the system
    ...
    :param verbose: boolean, print current iteration
